...
class Polynomial:
    ...
    def __init__(self, degree=None, coeffs=None,s=None):
    ...
    def getPartial(self,ini):
        c_nuevos=[]
        for x in range(ini,len(self.coeffs),2):
            c_nuevos.append(self.coeffs[x])
        c_nuevos.extend([0]*(len(self.coeffs)//2))
        # print("-------------------------------")
        # print(self.coeffs)
        # print("===============================")
        # print(c_nuevos)
        c_nuevos=self.coeffs.copy()
        #c_nuevos[0]=c_nuevos[1]
        return Polynomial(self.ring_degree,c_nuevos)
